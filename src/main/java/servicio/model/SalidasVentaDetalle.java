 ...
 * @author Computer
 */
public class SalidasVentaDetalle extends bean{
    ...
    List<SalidasVentaDetalleIngreso> salidasVentaDetalleIngresosList = new ArrayList<SalidasVentaDetalleIngreso>();
    ...
    public List<SalidasVentaDetalleIngreso> getSalidasVentaDetalleIngresosList() {
        return salidasVentaDetalleIngresosList;
    }

    public void setSalidasVentaDetalleIngresosList(List<SalidasVentaDetalleIngreso> salidasVentaDetalleIngresosList) {
        this.salidasVentaDetalleIngresosList = salidasVentaDetalleIngresosList;
    }
